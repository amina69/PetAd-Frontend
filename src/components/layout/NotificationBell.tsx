...
export function NotificationBell({ onClick, className, unreadCount: propUnreadCount }: NotificationBellProps) {
  const { count: hookCount } = useNotificationCount();
  const count = propUnreadCount !== undefined ? propUnreadCount : hookCount;
